...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/channel-status", middleware.UserAuth(), controller.GetChannelStatuses)
		...
		dataRoute.GET("/self/token-heatmap", middleware.UserAuth(), controller.GetUserTokenUsageHeatmap)
